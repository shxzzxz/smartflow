...
class BillQueryServiceImpl implements BillQueryService {
  ...
  BillSummaryReadModel _summaryForBill({
    ...
    return BillSummaryReadModel(
      ...
      period: bill.period,
      status: bill.status,
      // Consumption windows and repayment dates belong to bill items.  The
      // legacy summary fields stay nullable for source compatibility only.
      windowStartDate: null,
      windowBillingDate: null,
      windowRepaymentDate: null,
