...
@ProviderFor(archivedCategories)
final archivedCategoriesProvider = ArchivedCategoriesFamily._();

/// 归档分类（管理页归档区只读展示，parentId 指向归并目标）。

final class ArchivedCategoriesProvider
    extends
        $FunctionalProvider<
          AsyncValue<List<Account>>,
          List<Account>,
    ...
    with $FutureModifier<List<Account>>, $StreamProvider<List<Account>> {
  /// 归档分类（管理页归档区只读展示，parentId 指向归并目标）。
  ArchivedCategoriesProvider._({
    required ArchivedCategoriesFamily super.from,
    required AccountType super.argument,
  }) : super(
         retry: null,
         name: r'archivedCategoriesProvider',
         isAutoDispose: false,
         dependencies: null,
         $allTransitiveDependencies: null,
       );
  ...
  @override
  String debugGetCreateSourceHash() => _$archivedCategoriesHash();

  @override
  String toString() {
    return r'archivedCategoriesProvider'
        ''
        '($argument)';
  }
  ...
  Stream<List<Account>> create(Ref ref) {
    final argument = this.argument as AccountType;
    return archivedCategories(ref, argument);
  }

  @override
  bool operator ==(Object other) {
    return other is ArchivedCategoriesProvider && other.argument == argument;
  }
...
String _$archivedCategoriesHash() =>
    r'14ccfc7770be2ea7f8e3b0b4d28d1b90534ce932';

/// 归档分类（管理页归档区只读展示，parentId 指向归并目标）。

final class ArchivedCategoriesFamily extends $Family
    with $FunctionalFamilyOverride<Stream<List<Account>>, AccountType> {
  ArchivedCategoriesFamily._()
    : super(
        retry: null,
        name: r'archivedCategoriesProvider',
        dependencies: null,
  ...
  ArchivedCategoriesProvider call(AccountType type) =>
      ArchivedCategoriesProvider._(argument: type, from: this);

  @override
  String toString() => r'archivedCategoriesProvider';
}
