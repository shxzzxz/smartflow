...
import 'package:smartflow/feature/calendar/view_model/calendar_month_presentation.dart';
import 'package:smartflow/feature/calendar/view_model/lunar_label_resolver.dart';
...
void main() {
  group('calendar month presentation', () {
    ...
    test('filters selected day transaction and summarizes the day', () {
